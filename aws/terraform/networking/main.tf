...
resource "aws_security_group" "bastion_sg" {
  name = "ms_${var.general.environment}_sg_bastion"
...
resource "aws_security_group" "ui_sg" {
  name = "ms_${var.general.environment}_sg_ui"
...
resource "aws_security_group" "server_sg" {
  name = "ms_${var.general.environment}_sg_ecs"
...
resource "aws_security_group" "db_sg" {
  name = "ms_${var.general.environment}_sg_db"
...
resource "aws_key_pair" "bastion-keypair" {
  key_name = "${var.general.environment}-bastion-keypair"
